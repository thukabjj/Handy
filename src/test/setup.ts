  ...
  return {
    commands: {
      ...
      changeAudioFeedbackSetting: vi.fn(() =>
        Promise.resolve(mockResult(null)),
      ),
      ...
      changeBinding: vi.fn(() =>
        Promise.resolve(
          mockResult({ success: true, binding: null, error: null }),
        ),
      ),
      resetBinding: vi.fn(() =>
        Promise.resolve(
      ...
      getRecommendedFirstModel: vi.fn(() =>
        Promise.resolve(mockResult("whisper-tiny")),
      ),
      ...
      checkCustomSounds: vi.fn(() =>
        Promise.resolve({ start: false, stop: false }),
      ),
      ...
      addPostProcessPrompt: vi.fn(() =>
        Promise.resolve(
          mockResult({ id: "1", name: "Test", prompt: "Test prompt" }),
        ),
      ),
      ...
      startActiveListeningSession: vi.fn(() =>
        Promise.resolve(mockResult("session-1")),
      ),
      stopActiveListeningSession: vi.fn(() =>
        Promise.resolve(mockResult(null)),
      ),
      ...
      changeActiveListeningEnabledSetting: vi.fn(() =>
        Promise.resolve(mockResult(null)),
      ),
      changeActiveListeningSegmentDurationSetting: vi.fn(() =>
        Promise.resolve(mockResult(null)),
      ),
      changeOllamaBaseUrlSetting: vi.fn(() =>
        Promise.resolve(mockResult(null)),
      ),
      changeOllamaModelSetting: vi.fn(() => Promise.resolve(mockResult(null))),
      changeActiveListeningContextWindowSetting: vi.fn(() =>
        Promise.resolve(mockResult(null)),
      ),
      ...
      updateActiveListeningPrompt: vi.fn(() =>
        Promise.resolve(mockResult(null)),
      ),
      deleteActiveListeningPrompt: vi.fn(() =>
        Promise.resolve(mockResult(null)),
      ),
      setActiveListeningSelectedPrompt: vi.fn(() =>
        Promise.resolve(mockResult(null)),
      ),
      // Ask AI commands
      ...
      changeAskAiOllamaBaseUrlSetting: vi.fn(() =>
        Promise.resolve(mockResult(null)),
      ),
      changeAskAiOllamaModelSetting: vi.fn(() =>
        Promise.resolve(mockResult(null)),
      ),
      changeAskAiSystemPromptSetting: vi.fn(() =>
        Promise.resolve(mockResult(null)),
      ),
      listAskAiConversations: vi.fn(() => Promise.resolve(mockResult([]))),
      getAskAiConversation: vi.fn(() => Promise.resolve(mockResult(null))),
      deleteAskAiConversationFromHistory: vi.fn(() =>
        Promise.resolve(mockResult(null)),
      ),
