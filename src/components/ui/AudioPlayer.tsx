  ...
  return (
    <div className={`flex items-center gap-3 ${className}`}>
      ...
      <button
        onClick={togglePlay}
        disabled={isLoading}
        className="transition-colors cursor-pointer text-text hover:text-primary-light disabled:opacity-50"
      ...
      <div className="flex-1 flex items-center gap-2">
        ...
        <input
          ...
          className={`flex-1 h-1 rounded-lg appearance-none cursor-pointer focus:outline-none focus:ring-1 focus:ring-primary-light ${progressPercent >= 99.5 ? "[&::-webkit-slider-thumb]:translate-x-0.5 [&::-moz-range-thumb]:translate-x-0.5" : ""}`}
          style={{
